...
public class CoinController {
	...
	@GetMapping
	ResponseEntity<List<Coins>> getCoinList(@RequestParam(required=false, name="page") int page) throws Exception{
	...
	ResponseEntity<JsonNode> getMarketChart(
			@PathVariable String coinId, @RequestParam("days") int days ) throws Exception{
	...
	ResponseEntity<JsonNode> getTop50coinByMarketCapRank() throws Exception{
		String coin=coinService.getTop50CoinByMarketCapRange();
		JsonNode jsonNode=objectMapper.readTree(coin);
